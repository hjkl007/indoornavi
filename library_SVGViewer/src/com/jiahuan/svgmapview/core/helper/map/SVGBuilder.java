...
public class SVGBuilder
{
    ...
    /**
     * Applies a {@link android.graphics.ColorFilter} to the paint objects used to render the
     * SVG.
     */
     ...
     */
    public SVG build(Context context) throws SVGParseException
    {
        if (data == null)
        {
        ...
        try
        {
            final SVGParser.SVGHandler handler = new SVGParser.SVGHandler(context);
